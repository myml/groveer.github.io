...
// 配置信息
const config = {
  username: 'groveer', // GitHub repository 所有者，可以是个人或者组织。对应Gitalk配置中的owner
  repo: "groveer.github.io", // 储存评论issue的github仓库名，仅需要仓库名字即可。对应 Gitalk配置中的repo
  token: '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', // 前面申请的 personal access token
